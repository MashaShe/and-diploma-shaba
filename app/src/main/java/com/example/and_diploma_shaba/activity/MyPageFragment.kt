...
//import com.example.and_diploma_shaba.adapter.jobs.JobAdapter
//import com.example.and_diploma_shaba.adapter.jobs.OnJobsInteractionListener
...
import com.example.and_diploma_shaba.databinding.FragmentMyPageBinding
//import com.example.and_diploma_shaba.dto.Job
import com.example.and_diploma_shaba.dto.Post
import com.example.and_diploma_shaba.util.*
import javax.inject.Inject
import android.content.Intent
import android.net.Uri
import com.example.and_diploma_shaba.activity.utils.*
...
//                mwPostViewModel.openMedia(post.postId){ file ->
...
//            }
            ...
            override fun onEdit(post: Post, position: Int) {
                val bundle = Bundle()
                bundle.putLong("post", post.postId)
            ...
            override fun onRemove(post: Post) {
                editPosts.deletePost(post.postId)
...
//        }
        ...
        viewModel.myInfoDataState.observe(viewLifecycleOwner) { users ->
            if (users.isNotEmpty()) {
                binding.username.text = "Login: ${users[0].userLogin}"
